...
public class ManagerDAOImpl implements ManagerDAO{
	...
	public Manager selectById(int id) {
		log.info("searching Manager by id: " + id);
		
		Session ses = HibernateUtil.getSession();
		
		Manager Manager = (Manager) ses.createNativeQuery("SELECT * FROM store_Managers WHERE store_Manager_id = " + id + "", Manager.class).getSingleResult();
	...
	public Manager selectByFirstName(String firstName) {
		...
		Manager Manager = (Manager) ses.createNativeQuery("SELECT * FROM store_Managers WHERE store_Manager_firstname = '" + firstName + "'", Manager.class).getSingleResult();
