...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public EmployeeServiceImpl(EmployeeDAOImpl dao) {
		super();
		this.udao = dao; //this is the same as this: private static EmployeeDAO udao = new EmployeeDAOImpl();
	}
	...
	public Employee login(String Employeename, String password) {
		...
		//utilize Streams API
		Optional<Employee> Employees = udao.selectAll()
				.stream()
	...
	public boolean deleteEmployee(Employee Employee) {
		log.info("in service layer. removing Employee: " + Employee);
		return udao.delete(Employee);
	}
