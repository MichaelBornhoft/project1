...
public class ERSApproved {
		...
		@Column(name = "approved_employee_ticket_id")
		...
		@Column(name = "approved_ticket_name", unique = true, nullable = false) // similar to adding UNIQUE NOT NULL constraint in																// SQL
		private String ticketName() {
			return erm.getTicketName();
		}

		@Column(name = "approved_ticket_description", unique = true, nullable = false)
		private String description() {
			return erm.getDescription();
		}

		// amount of request
		@Column(name = "approved_ticket_amount", precision = 10, scale = 2)
		private double ticketAmount() {
			return erm.getTicketAmount();
		}

		// status of request. 0 = denied, 1 = pending, 2 = approved
		@Column(name = "approved_ticket_status")
		@GeneratedValue(strategy = GenerationType.IDENTITY)
